                    ...
                    <div className="user-menu-wrap"
                      ...
                      {menuOpen && (
                        <div className="user-dropdown">
                          ...
                          {[
                            { icon: <LniIcon name="package" />,       label:"Мои заказы",  page:"orders" },
                            { icon: <LniIcon name="heart" />,         label:"Избранное",   page:"favorites" },
                            { icon: <LniIcon name="coins" />,         label:"Перевод " + currName(), page:"transfer" },
                            { icon: <LniIcon name="cog" />,           label: isAdmin ? "Настройки" : "Профиль", page:"settings" },
                          ].map(item => (
                          ...
                          <button className="user-dropdown-item danger" onClick={() => { setCurrentUser(null); storage.set("cm_session", null); setPage("shop"); setMenuOpen(false); }}>
                            <span className="udi-icon"><LniIcon name="exit" /></span>
                            Выйти
                          </button>
                        </div>
                      )}
      ...
      <footer className="rd-footer" style={appearance.footerBg ? {background: appearance.footerBg} : {}}>
        <div className="container">
          <div className="rd-footer-inner">
            ...
            <div className="rd-footer-version" style={{fontSize:"11px",color:"rgba(255,255,255,0.3)",marginTop:"6px"}}>Версия портала 6</div>
          </div>
          {/* Social icons */}
          {(() => {
  ...
  return (
    <div>
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"20px"}}>
        <div style={{fontWeight:700,fontSize:"18px",color:"var(--rd-dark)"}}>{editId === "new" ? <><LniIcon name="plus" /> Новое задание</> : `Задания (${taskList.length})`}</div>
      ...
      {editId && (
        <div className="product-form-card" style={{marginBottom:"24px"}}>
          <div className="product-form-title">{editId === "new" ? <><LniIcon name="plus" /> Новое задание</> : <><LniIcon name="pencil-alt" /> Редактирование</>}</div>
          ...
          <div style={{display:"flex",gap:"10px",marginTop:"16px"}}>
            <button className="btn btn-primary" onClick={save}><LniIcon name="save" /> Сохранить</button>
        ...
        {taskList.map(task => (
          <div key={task.id} style={{background:"#fff",border:"1.5px solid var(--rd-gray-border)",borderRadius:"var(--rd-radius)",padding:"18px 22px",boxShadow:"var(--rd-shadow)",display:"flex",alignItems:"center",gap:"16px"}}>
            ...
            <div style={{display:"flex",gap:"8px",flexShrink:0}}>
              <button className="btn btn-ghost btn-sm" onClick={() => startEdit(task)} title="Редактировать"><LniIcon name="pencil-alt" /></button>
              <button className="btn btn-ghost btn-sm" onClick={() => deleteTask(task.id)} style={{color:"var(--rd-red)"}} title="Удалить"><LniIcon name="trash" /></button>
            </div>
          </div>
        ))}
      </div>
                ...
                <div key={a.id} className="auction-admin-card">
                  ...
                  <div style={{flex:1,minWidth:0}}>
                    <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:"10px"}}>
                      ...
                      <button className="btn btn-ghost btn-sm" onClick={() => deleteAuction(a.id)} style={{color:"var(--rd-red)",flexShrink:0}} title="Удалить"><LniIcon name="trash" /></button>
                    </div>
                  </div>
                </div>
              );
      ...
      <div className="product-form-card">
        ...
        <div className="form-field" style={{marginTop:"12px"}}>
          ...
          <div style={{display:"flex",gap:"10px",alignItems:"center",flexWrap:"wrap"}}>
            <label htmlFor="auction-img-input" className="btn btn-secondary btn-sm" style={{cursor:"pointer"}}><LniIcon name="camera" /> Загрузить фото</label>
        ...
        <button className="btn btn-primary" style={{marginTop:"16px",width:"100%"}} onClick={create}><LniIcon name="hammer" /> Создать аукцион</button>
      </div>
    </div>
  );
}
                ...
                {editIdx === idx ? (
                  <div>
                    ...
                    <div style={{display:"flex",gap:"10px",marginTop:"12px"}}>
                      <button className="btn btn-primary btn-sm" onClick={saveEdit}><LniIcon name="save" /> Сохранить</button>
                  ...
                  <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:"12px"}}>
                    ...
                    <div style={{display:"flex",gap:"6px",flexShrink:0}}>
                      ...
                      <button className="btn btn-ghost btn-sm" onClick={() => deleteItem(idx)} title="Удалить" style={{color:"var(--rd-red)"}} title="Удалить"><LniIcon name="trash" /></button>
                    </div>
                  </div>
                )}
              </div>
      ...
      {!embedded && (
        <>
          ...
          <div className="stats-grid">
            {[
              { label: "Пользователей", val: Object.keys(users).filter(u => u !== "admin").length, icon: "users" },
              { label: "Заказов всего", val: orders.length, icon: "package" },
              { label: "Товаров в каталоге", val: products.length, icon: "shopping-bag" },
            ].map(s => (
              <div key={s.label} className="stat-card">
                <div className="sc-icon"><LniIcon name={s.icon} size="28px" /></div>
        ...
        <div>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"20px",flexWrap:"wrap",gap:"12px"}}>
            ...
            <button className="btn btn-primary btn-sm" onClick={openNewProduct} style={{gap:"6px"}}>
              <LniIcon name="plus" /> Добавить товар
            </button>
          </div>
            ...
            <div className="modal-overlay" onClick={resetForm}>
              <div className="modal-box" onClick={e => e.stopPropagation()} style={{maxWidth:"680px",width:"95vw",maxHeight:"90vh",overflowY:"auto",padding:"32px 28px"}}>
                ...
                <div style={{fontWeight:800,fontSize:"22px",marginBottom:"24px",color:"var(--rd-dark)"}}>
                  {editingProduct ? <><LniIcon name="pencil-alt" /> Редактирование товара</> : <><LniIcon name="plus" /> Новый товар</>}
                </div>
        ...
        <div>
          <div style={{marginBottom:"12px",display:"flex",alignItems:"center",gap:"10px",flexWrap:"wrap"}}>
            ...
            <div style={{marginLeft:"auto",display:"flex",gap:"8px",flexWrap:"wrap"}}>
              <button className="btn btn-secondary btn-sm" onClick={exportUsersCSV}><LniIcon name="download" /> CSV</button>
              <button className="btn btn-secondary btn-sm" onClick={exportUsersXLSX}><LniIcon name="download" /> XLSX</button>
            ...
            {userList.map(([username, user]) => (
              <div key={username} className="user-card">
                ...
                <div className="user-card-controls">
                  ...
                  <button className="btn btn-ghost btn-sm" onClick={() => setUserEditModal({username, user})} title="Редактировать"><LniIcon name="pencil-alt" /></button>
                  <button className="btn btn-ghost btn-sm" onClick={() => toggleAdmin(username)} title={user.role === "admin" ? "Разжаловать" : "Сделать админом"} style={{fontSize:"16px"}}>
                    {user.role === "admin" ? <LniIcon name="user" /> : <LniIcon name="shield" />}
                  </button>
                  <button className="btn btn-ghost btn-sm" onClick={() => deleteUser(username)} title="Удалить" style={{color:"var(--rd-red)"}}><LniIcon name="trash" /></button>
                </div>
              </div>
            ))}
          </div>
              ...
              <div key={cat} className="product-admin-card">
                ...
                <div className="pac-actions">
                  {editCatIdx === i
                    ...
                    : <button className="btn-icon" onClick={() => { setEditCatIdx(i); setEditCatVal(cat); }} title="Редактировать"><LniIcon name="pencil-alt" /></button>
                  }
          ...
          <div style={{background:"#fff",border:"1.5px solid var(--rd-gray-border)",borderRadius:"var(--rd-radius)",padding:"32px 28px",boxShadow:"var(--rd-shadow-md)",marginBottom:"20px"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"}}>
              <div style={{border:"1.5px solid var(--rd-gray-border)",borderRadius:"var(--rd-radius-sm)",padding:"24px",textAlign:"center",cursor:"pointer",transition:"all 0.15s"}}
                ...
                <div className="btn btn-primary btn-sm btn-block"><LniIcon name="download" /> Скачать XLSX</div>
              </div>
              <div style={{border:"1.5px solid var(--rd-gray-border)",borderRadius:"var(--rd-radius-sm)",padding:"24px",textAlign:"center",cursor:"pointer",transition:"all 0.15s"}}
                onClick={exportCSV}
                onMouseEnter={e=>{e.currentTarget.style.borderColor="var(--rd-red)";e.currentTarget.style.boxShadow="var(--rd-shadow-md)";e.currentTarget.style.transform="translateY(-2px)"}}
                ...
                <div className="btn btn-secondary btn-sm btn-block"><LniIcon name="download" /> Скачать CSV</div>
              </div>
            </div>
          </div>
...
function SeoSettingsTab({ appearance, saveAppearance, notify }) {
  ...
  return (
    <div>
      <div className="settings-card">
        <div className="settings-section-title"><LniIcon name="search-alt" /> SEO настройки</div>
        <div style={{fontSize:"13px",color:"var(--rd-gray-text)",marginBottom:"24px",lineHeight:"1.7"}}>
...
function SettingsPage({ currentUser, users, saveUsers, notify, dbConfig, saveDbConfig, refreshDbConfig, pgConfig, savePgConfig, isPgActive, isAdmin, orders, saveOrders, products, saveProducts, categories, saveCategories, appearance, saveAppearance, markOrdersSeen, transfers, saveTransfers, faq, saveFaq, tasks, saveTasks, taskSubmissions, saveTaskSubmissions, auctions, saveAuctions, sqliteDisabled, setSqliteDisabled }) {
  ...
  const SIDEBAR_TABS = isAdmin ? [
    { id: "profile",    icon: <LniIcon name="user" />,         label: "Профиль" },
    { id: "appearance", icon: <LniIcon name="brush-alt" />,    label: "Внешний вид" },
    { id: "banner",     icon: <LniIcon name="image" />,        label: "Баннер" },
    { id: "currency",   icon: <LniIcon name="coins" />,        label: "Валюта" },
    { id: "seo",        icon: <LniIcon name="search-alt" />,   label: "SEO" },
    { id: "database",   icon: <LniIcon name="database" />,     label: "База данных" },
    { id: "socials",    icon: <LniIcon name="network" />,      label: "Соц. сети" },
    { id: "faq",        icon: <LniIcon name="question-circle" />, label: "Вопрос / Ответ" },
    { id: "tasks",      icon: <LniIcon name="target-revenue" />, label: "Задания" },
    { id: "auction",    icon: <LniIcon name="hammer" />,       label: "Аукцион" },
    { id: "shop",       icon: <LniIcon name="store" />,        label: "Управление магазином" },
    { id: "integrations", icon: <LniIcon name="plug" />,       label: "Интеграции" },
  ] : [
    { id: "profile", icon: <LniIcon name="user" />, label: "Профиль" },
  ];
  const CURRENCY_SUB_TABS = isAdmin ? [
    { id: "currency_settings", icon: <LniIcon name="pencil-alt" />, label: "Настройки" },
    { id: "currency_birthday", icon: <LniIcon name="cake" />,       label: "День рождения" },
    { id: "currency_bulk",     icon: <LniIcon name="money-bag" />,  label: "Начисление" },
  ] : [
    { id: "currency_settings", icon: <LniIcon name="pencil-alt" />, label: "Настройки" },
  ];
  const ADMIN_SUB_TABS = [
    { id: "users",      icon: <LniIcon name="users" />,         label: "Пользователи" },
    { id: "products",   icon: <LniIcon name="shopping-bag" />,  label: "Товары" },
    { id: "categories", icon: <LniIcon name="tag" />,           label: "Категории" },
    { id: "orders",     icon: <LniIcon name="package" />,       label: "Заказы" },
    { id: "faq",        icon: <LniIcon name="question-circle" />, label: "Вопрос-ответ" },
    { id: "import",     icon: <LniIcon name="upload" />,        label: "Импорт" },
    { id: "export",     icon: <LniIcon name="download" />,      label: "Экспорт" },
  ];
