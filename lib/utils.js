...
// Умное сжатие изображений с поддержкой PNG/GIF прозрачности и авто-снижением качества
export const compressImage = (dataUrl, maxW = 1200, maxH = 1200, quality = 0.85, targetKB = 300) => {
...
export function applyTheme(themeKey, customColors = {}) {
  ...
  if (customColors.shopTextColor) {
    r.setProperty('--rd-shop-text', customColors.shopTextColor);
  } else {
    r.removeProperty('--rd-shop-text');
  }
}
